package classwork.lesson06.explicity;
...
public class FirstTest {
    ...
    public void firstResultContainsText() {
        ...
        (new WebDriverWait(driver,10)).until(ExpectedConditions.textToBePresentInElementLocated((By) driver.findElement(By.xpath("//*[@id=\"index\"]/div[2]/ul/li[1]")),"dress"));
